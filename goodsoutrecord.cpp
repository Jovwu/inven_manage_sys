...
GoodsOutRecord::GoodsOutRecord() :Window("商品出库记录界面", WIN_POS_X, WIN_POS_Y, WIN_WIDTH, WIN_HEIGHT, "BASE")
{
}

int GoodsOutRecord::Init()
{
	...
	this->GoodsOutInfo->SetHint("商品出库记录");
...
int GoodsOutRecord::Event(Widget* Obj)
{
	if (Obj == this->Query) 
	{
...
int GoodsOutRecord::QueryButtonEvent()
{
